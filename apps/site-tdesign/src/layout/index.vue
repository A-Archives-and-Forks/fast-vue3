...
const footerGroups = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'TDesign Vue Next', href: 'https://tdesign.tencent.com/' },
...
<template>
  <t-layout class="site-layout">
    <t-header class="site-header" :class="{ 'is-scrolled': isScrolled }">
      <div class="site-header-inner">
        <RouterLink to="/" class="site-logo">
          <span class="logo-mark">F</span>
          <span class="logo-text">Fast Vue3</span>
          <t-tag theme="primary" variant="light" class="logo-tag">
            TDesign
          </t-tag>
        </RouterLink>
        <nav class="site-nav">
    ...
    <t-footer class="site-footer">
      <div class="footer-inner">
        ...
        <t-divider style="margin: 24px 0 16px" />
        <div class="footer-copyright">
          Fast Vue3 &copy; {{ year }} &middot; TDesign Vue Next 生态模板
        </div>
      </div>
    </t-footer>
