...
const footerGroups = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Ant Design Vue', href: 'https://www.antdv.com/' },
...
<template>
  <ALayout class="site-layout">
    <ALayoutHeader class="site-header" :class="{ 'is-scrolled': isScrolled }">
      <div class="site-header-inner">
        <RouterLink to="/" class="site-logo">
          <span class="logo-mark">F</span>
          <span class="logo-text">Fast Vue3</span>
          <ATag color="blue" class="logo-tag">Ant Design Vue</ATag>
        </RouterLink>
        <nav class="site-nav">
          <RouterLink
    ...
    <ALayoutContent class="site-content">
      <RouterView />
    </ALayoutContent>

    <ALayoutFooter class="site-footer">
      <div class="footer-inner">
        ...
        <ADivider style="margin: 24px 0 16px" />
        <div class="footer-copyright">
          Fast Vue3 &copy; {{ year }} &middot; Ant Design Vue 生态模板
        </div>
      </div>
    </ALayoutFooter>
