...
const footerGroups = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Arco Design Vue', href: 'https://arco.design/' },
...
<template>
  <a-layout class="site-layout">
    <a-layout-header class="site-header" :class="{ 'is-scrolled': isScrolled }">
      <div class="site-header-inner">
        <RouterLink to="/" class="site-logo">
          <span class="logo-mark">F</span>
          <span class="logo-text">Fast Vue3</span>
          <a-tag color="arcoblue" class="logo-tag">Arco Design</a-tag>
        </RouterLink>
        <nav class="site-nav">
          <RouterLink
    ...
    <a-layout-footer class="site-footer">
      <div class="footer-inner">
        ...
        <div class="footer-copyright">
          Fast Vue3 &copy; {{ year }} &middot; Arco Design Vue 生态模板
        </div>
      </div>
    </a-layout-footer>
