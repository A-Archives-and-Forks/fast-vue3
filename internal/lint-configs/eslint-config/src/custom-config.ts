...
const customConfig: Linter.Config[] = [
          ...
          patterns: [
            {
              group: ['@fast-vue3/*'],
              message:
                'The @core package cannot import the @fast-vue3 package, please use the @core package itself',
            },
          ],
        },
      ],
  ...
  {
    // @core/shared内部组件，不能引入@fast-vue3/* 或者 @fast-vue3-core/* 里面的包
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@fast-vue3/*', '@fast-vue3-core/*'],
              message:
                'The @fast-vue3-core/shared package cannot import the @fast-vue3 package, please use the @core/shared package itself',
            },
          ],
        },
      ],
