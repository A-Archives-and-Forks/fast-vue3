...
import { getPackages } from '@fast-vue3/node-utils';
...
const DEFAULT_CONFIG = {
  ...
  ignoreMatches: [
    ...
    'vitest',
    'tsdown',
    '@fast-vue3/tailwind-config',
    '@fast-vue3/tsconfig',
    '@fast-vue3/vite-config',
    '@types/*',
    '@fast-vue3-core/design',
  ],
  // 需要忽略的包
  ignorePackages: [
    '@fast-vue3/backend-mock',
    '@fast-vue3/commitlint-config',
    '@fast-vue3/eslint-config',
    '@fast-vue3/node-utils',
    '@fast-vue3/oxfmt-config',
    '@fast-vue3/oxlint-config',
    '@fast-vue3/stylelint-config',
    '@fast-vue3/tsconfig',
    '@fast-vue3/vite-config',
    '@fast-vue3/vsh',
  ],
